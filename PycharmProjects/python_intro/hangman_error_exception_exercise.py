...
########################## TRY & EXCEPT ################################################
try:
    file = open("hangman_word.py")                                                               # opens the file
    ...
    dashList = []
    for i in linedash:            #  comparison with letter in random word
        dashList.append(i)
...
except FileNotFoundError as errmessage:                                                            # if file x be found in 'try', do this
    print("The file you requested, there has been an error!")
    print(errmessage)                                                                              # MORE info of error
